          ...
          <View>
            ...
            <View style={styles.card}>
              ...
              <TouchableOpacity style={styles.dangerItem} onPress={handleLogout}>
                ...
                <TouchableOpacity style={[styles.btnDanger, { backgroundColor: '#f59e0b' }]}>
            ...
            <View style={[styles.card, styles.dangerCard]}>
              ...
              <View style={styles.dangerItem}>
                ...
                <TouchableOpacity style={styles.btnDanger} onPress={() => {
                  Alert.alert(
                    'Delete Account',
                    ...
                    [
                      { text: 'Cancel', style: 'cancel' },
                      {
                        ...
                        onPress: () => {
                          ...
                          authApi.delete(user?.email).then(() => {
                            router.replace('/login');
                          })
                        },
                      },
        ...
        return (
          <View>
            ...
            <View style={styles.card}>
              ...
              <TouchableOpacity style={styles.saveButton} onPress={()=>alert('comming soon!')}>
                <LinearGradient
                  colors={['#6366f1', '#a855f7', '#ec4899']}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
