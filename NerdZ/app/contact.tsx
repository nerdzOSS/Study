...
export default function ContactScreen() {
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      setIsSending(false);
      Alert.alert('Success', 'Message sent successfully! We\'ll get back to you within 24 hours.');
      setName('');
      setEmail('');
      setSubject('');
      setMessage('');
  ...
  const openEmail = () => {
    Linking.openURL('mailto:support@nerdz.com');
  };
  ...
  const openSocial = (platform: string) => {
    ...
    const urls: { [key: string]: string } = {
      twitter: 'https://twitter.com/nerdz',
      linkedin: 'https://linkedin.com/company/nerdz',
      discord: 'https://discord.gg/nerdz',
      github: 'https://github.com/nerdz',
    };
          ...
          <View style={styles.contactInfo}>
            <TouchableOpacity style={styles.infoCard} onPress={openEmail}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>support@nerdz.com</Text>
            ...
            <View style={styles.infoCard}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue}>123 Study Street{'\n'}San Francisco, CA 94102</Text>
